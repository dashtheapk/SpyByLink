...
[![Video Tutorial](https://github.com/dashtheapk/SpyByLink/blob/main/vid.png)](https://github.com/dashtheapk/SpyByLink/blob/main/vid.mp4?raw=true)
...
1. Copy it's API key
1. Clone the repo using `git clone https://github.com/dashtheapk/SpyByLink
1. `cd TrackDown`
1. Create a environment variable in `.env` file named `bot` and put your telegram bot token as it's value.
1. Replace your website URL at [index.js](https://github.com/dashtheapk/SpyByLink/blob/8d2b963bc96d34282589d47240a9db56b5ce79f5/index.js#L15)
1. Run `npm install`
